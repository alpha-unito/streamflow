...
async def get_slurm_deployment_config(_context: StreamFlowContext) -> DeploymentConfig:
...
async def get_ssh_deployment_config(_context: StreamFlowContext) -> DeploymentConfig:
    if config := cast(
