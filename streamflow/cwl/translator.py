...
def _create_command(
    ...
    command = CWLCommand(
        ...
        command_tokens=[
            _get_command_token(binding=a, is_shell_command=is_shell_command)
...
class CWLTranslator:
    ...
    def _inject_input(
        ...
        schedule_step = workflow.create_step(
            ...
            input_directory=target.workdir,
            output_directory=target.workdir,
            tmp_directory=target.workdir,
